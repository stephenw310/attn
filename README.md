...
- **[docs/M3-PLAN.md](docs/M3-PLAN.md)** — M3 implementation record: shipped sync, mailboxes, search, palette, and themes; planned splits, chord guide, inbox zero, and Move
