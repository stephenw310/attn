...
describe('Gmail signature separator', () => {
  it('collapses with the signature but exports outside it without losing the delimiter space or adding blank rows', () => {
    let html = `<div dir="ltr"><div>Hello</div><div><br></div><span class="gmail_signature_prefix">-- </span><br>${signature}</div>`
