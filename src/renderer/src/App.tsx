        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {message.attachments.map((attachment) => (
            <button
              ...
              className="cursor-pointer rounded-lg border border-edge bg-active px-3 py-2 text-left text-xs text-ink-dim hover:border-accent hover:text-ink"
            ...
            >
              ...
              <span className="ml-2 text-ink-faint tabular-nums">{formatBytes(attachment.sizeBytes)}</span>
            </button>
          ))}
        </div>
      )}
