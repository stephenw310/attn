...
export const SELECT =
  'min-w-0 max-w-[min(21rem,45vw)] cursor-pointer border border-edge bg-ground px-2.5 py-1.5 text-sm text-ink outline-none focus:border-accent'
export const INPUT =
  'border border-edge bg-ground px-2.5 py-1.5 text-sm text-ink outline-none focus:border-accent'
/** A secondary button beside a setting: Reconnect, Remove, Move up. */
export const ACTION_BUTTON =
  'cursor-pointer whitespace-nowrap border border-edge px-2.5 py-1.5 text-sm text-ink-dim hover:bg-active hover:text-ink disabled:cursor-default disabled:opacity-45 disabled:hover:bg-transparent'
