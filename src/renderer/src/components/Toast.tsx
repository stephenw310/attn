...
export function Toast({
  ...
  if (toast) {
    ...
    return (
      ...
      >
        <div
          className="app-confirmation-toast min-w-56 overflow-hidden rounded-xl border border-white/70 bg-ink text-base font-semibold text-ground shadow-[0_12px_40px_rgba(0,0,0,0.65)]"
          style={timingStyle}
        >
          <div className="px-5 py-3">{toast.message}</div>
          {toast.countdown ? (
