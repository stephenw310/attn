...
export function Toast({
  ...
  if (toast) {
    ...
    return (
      ...
      >
        <div
          className="app-confirmation-toast min-w-56 max-w-full overflow-hidden border border-ground/70 bg-ink text-base font-semibold text-ground shadow-toast"
          style={timingStyle}
        >
  ...
  return (
    ...
    >
      <div className="min-w-64 overflow-hidden border border-ground/70 bg-ink text-ground shadow-toast">
